...
import {
  useAnalysisRunDetailWorkflowRunsQueryParams,
  type AnalysisRunWorkflowRunStatus,
} from '../hooks/useAnalysisRunDetailWorkflowRunsQueryParams';
...
export function AnalysisRunDetailWorkflowRunsTable() {
  ...
  const { search, workflowRunsQueryParams, setPage, setRowsPerPage, setSearchQuery } =
    useAnalysisRunDetailWorkflowRunsQueryParams(analysisRunOrcabusId);
  const {
