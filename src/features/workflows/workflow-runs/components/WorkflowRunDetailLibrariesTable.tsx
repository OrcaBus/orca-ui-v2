...
import { useWorkflowRunDetailLibrariesQueryParams } from '../hooks/useWorkflowRunDetailLibrariesQueryParams';
...
export function WorkflowRunDetailLibrariesTable() {
  ...
  const {
    ...
    setOrderBy,
    getOrderDirection,
  } = useWorkflowRunDetailLibrariesQueryParams(libraryIds);
  const {
