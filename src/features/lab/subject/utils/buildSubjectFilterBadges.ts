...
export interface BuildSubjectFilterBadgesParams {
...
/**
 * Build active filter badges for AdvancedFilterBar from subject search + filter state.
 */
export function buildSubjectActiveFilterBadges({
  filterFields,
  search,
  setSearchQuery,
  filterValues,
  setFilterValues,
}: BuildSubjectFilterBadgesParams): FilterBadge[] {
