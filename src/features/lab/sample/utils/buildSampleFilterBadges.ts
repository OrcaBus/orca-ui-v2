...
export interface BuildSampleFilterBadgesParams {
...
/**
 * Build active filter badges for AdvancedFilterBar from sample search + filter state.
 */
export function buildSampleActiveFilterBadges({
  filterFields,
  search,
  setSearchQuery,
  filterValues,
  setFilterValues,
}: BuildSampleFilterBadgesParams): FilterBadge[] {
