...
import { useAnalysisContextsListQueryParams } from './useAnalysisContextsListQueryParams';

export function useAnalysisContextsPageQueryParams() {
  const analysisContextsQueryParams = useAnalysisContextsListQueryParams();
