...
export function SampleSheetViewModal({ isOpen, onClose, sampleSheet }: SampleSheetViewModalProps) {
  ...
  return (
    <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4'>
      <div className='flex max-h-[90vh] w-full max-w-4xl flex-col rounded-lg bg-white shadow-xl dark:bg-neutral-900'>
        {/* Header */}
        <div className='flex shrink-0 items-center justify-between border-b border-neutral-200 px-6 py-4 dark:border-neutral-700'>
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <p className='text-xs text-neutral-500 dark:text-neutral-400'>Sample Sheet Viewer</p>
            </div>
          </div>
          <div className='flex items-center gap-2'>
            {activeTab !== 'formatted' && (
              <button
                ...
                className='flex items-center gap-1.5 rounded-md border border-neutral-300 px-3 py-1.5 text-xs font-medium text-neutral-700 transition-colors hover:bg-neutral-50 dark:border-neutral-600 dark:text-neutral-200 dark:hover:bg-neutral-800'
              >
        ...
        {/* Footer */}
        <div className='flex shrink-0 justify-end border-t border-neutral-200 px-6 py-3 dark:border-neutral-700'>
          <button
            onClick={onClose}
